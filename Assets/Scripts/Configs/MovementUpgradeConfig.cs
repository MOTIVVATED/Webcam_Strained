...
public class MovementUpgradeConfig : ScriptableObject
{
	...
	public Tier[] tiers = new Tier[6]
	{
		...
		new Tier { label = "Speed 10", useLegacyLaneStep = false, speed = 10, cost = 100 },
		new Tier { label = "Speed 11", useLegacyLaneStep = false, speed = 11, cost = 200 },
		new Tier { label = "Speed 12", useLegacyLaneStep = false, speed = 12, cost = 350 },
		new Tier { label = "Speed 13", useLegacyLaneStep = false, speed = 13, cost = 500 },
		new Tier { label = "Speed 14", useLegacyLaneStep = false, speed = 14, cost = 800 },
	};
}