...
public class LaneUpgradeConfig : ScriptableObject
{
	...
	public Tier[] tiers = new Tier[6]
	{
		...
		new Tier { label = "4", activeLaneCount = 4, cost = 25 },
		new Tier { label = "5", activeLaneCount = 5, cost = 25 },
		new Tier { label = "6", activeLaneCount = 6, cost = 25 },
		new Tier { label = "7", activeLaneCount = 7, cost = 25 },
	};
}